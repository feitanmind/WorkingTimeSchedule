...
class Notification
{
    ...
    static createAndDisplayWarningAboutCantGrantVacationToUserOnThisDay()
    {
        window.history.pushState({}, document.title, "/" + "app/");
        const toast = document.createElement("div");
        toast.setAttribute("id","toast");
        // form.style.display = "none";
        toast.style.height = "11vh";
        document.body.appendChild(toast);
        toast.style.position = 'absolute';
        toast.style.display = 'flex';
        toast.innerHTML ='<div id="toastBody"><p>😭</p><p><strong>Warning</strong></p><p>You can\'t grant vacation to user on this day because user working on some shift in this day</p></div><div id="toastLostVacation"></div>';
        // const toastLost = toast.appendChild(document.createElement("div"));
        // toastLost.setAttribute("id","toastLost");
        const toastLost =  document.getElementById('toastLostVacation');
    ...
    static createAndDisplayWarningAboutNoHoursLeft()
    {
        window.history.pushState({}, document.title, "/" + "app/");
        const toast = document.createElement("div");
        toast.setAttribute("id","toast");
        ...
        toast.style.position = 'absolute';
        toast.style.display = 'flex';
        toast.innerHTML ='<div id="toastBody"><p>😮‍💨</p><p><strong>Warning</strong></p><p>You can\'t sign user to this day because user have not enough time in month to use</p></div><div id="toastLost"></div>';
        // const toastLost = toast.appendChild(document.createElement("div"));
        // toastLost.setAttribute("id","toastLost");
        const toastLost =  document.getElementById('toastLost');
        let width = 0;
